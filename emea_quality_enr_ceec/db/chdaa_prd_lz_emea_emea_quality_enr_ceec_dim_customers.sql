CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_ceec.dim_customers (
  iqvia_brick STRING,
  position STRING,
  chain_type STRING,
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/ceec/dim_customers'
TBLPROPERTIES (
