CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_ceec.fact_transactions_bkp (
  document_id STRING,
...
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/ceec/fact_transactions_bkp'
TBLPROPERTIES (
