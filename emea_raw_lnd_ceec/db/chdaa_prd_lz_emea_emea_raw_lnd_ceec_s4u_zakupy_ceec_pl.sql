CREATE TABLE chdaa_prd_lz_emea.emea_raw_lnd_ceec.s4u_zakupy_ceec_pl (
  symbol_obcy STRING,
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://raw@zpdatacoresadpemea.dfs.core.windows.net/landing/ceec/s4u_zakupy_ceec_pl'
TBLPROPERTIES (
