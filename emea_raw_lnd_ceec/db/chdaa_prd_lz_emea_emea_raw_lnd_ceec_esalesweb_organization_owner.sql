CREATE TABLE chdaa_prd_lz_emea.emea_raw_lnd_ceec.esalesweb_organization_owner (
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://raw@zpdatacoresadpemea.dfs.core.windows.net/landing/ceec/esalesweb_organization_owner'
TBLPROPERTIES (
