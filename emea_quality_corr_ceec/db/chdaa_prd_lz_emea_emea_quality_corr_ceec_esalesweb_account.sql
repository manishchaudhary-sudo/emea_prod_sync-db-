CREATE TABLE chdaa_prd_lz_emea.emea_quality_corr_ceec.esalesweb_account (
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/correction/ceec/esalesweb_account'
TBLPROPERTIES (
