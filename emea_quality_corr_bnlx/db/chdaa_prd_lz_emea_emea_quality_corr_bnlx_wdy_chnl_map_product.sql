CREATE TABLE chdaa_prd_lz_emea.emea_quality_corr_bnlx.wdy_chnl_map_product (
  ...
  ETLChecksum STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/correction/bnlx/wdy_chnl_map_product'
TBLPROPERTIES (
