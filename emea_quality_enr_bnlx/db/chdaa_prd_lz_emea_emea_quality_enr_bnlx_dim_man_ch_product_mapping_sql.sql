CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_bnlx.dim_man_ch_product_mapping_sql (
...
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/bnlx/dim_man_ch_product_mapping_sql'
TBLPROPERTIES (
