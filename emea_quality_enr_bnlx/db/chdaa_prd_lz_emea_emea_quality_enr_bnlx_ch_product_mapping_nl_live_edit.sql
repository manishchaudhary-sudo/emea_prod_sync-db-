CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_bnlx.ch_product_mapping_nl_live_edit (
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/bnlx/ch_product_mapping_nl_live_edit'
TBLPROPERTIES (
