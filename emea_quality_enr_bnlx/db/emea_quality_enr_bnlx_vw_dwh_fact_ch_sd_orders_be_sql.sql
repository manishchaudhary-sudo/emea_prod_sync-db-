CREATE VIEW emea_quality_enr_bnlx.vw_dwh_fact_ch_sd_orders_be_sql (
  `0doc_number`,
  `0s_ord_item`,
  `0dsdel_date`,
  sapsdreqdeldate,
...
prodbe.0material___t,prodbe.0matl_type,prodbe.0matl_type___t,prodbe.0base_uom,prodbe.0base_uom___t,prodbe.dprodh1,prodbe.dprodh1___t,prodbe.dprodh2,
prodbe.dprodh2___t,prodbe.dprodh3,prodbe.dprodh3___t,prodbe.dprodh4,prodbe.dprodh4___t,prodbe.dprodh5,prodbe.dprodh5___t,prodbe.dprodh6,prodbe.dprodh6___t,prodbe.dbrand,
prodbe.dbrand___t,prodbe.division,prodbe.division___t,prodbe.dbrandf,prodbe.dbrandf___t,prodbe.0prodh6,prodbe.0prodh6___t,prodbe.dan_cog,prodbe.dan_cog___t,prodbe.0eanupc,
prodbe.d_fgps,prodbe.d_fgpsu,prodbe.d_cbpck,prodbe.d_cpckd,prodbe.d_pptyp,prodbe.d_trian,prodbe.d_prsite,prodbe.d_pasite,prodbe.dlp_form,prodbe.dlp_form__t,prodbe.d_lcpha,
prodbe.0extmatlgrp,prodbe.d_gtin1,prodbe.d_gtin1c,prodbe.d_gtin1u,prodbe.d_gtin2,prodbe.d_gtin2c,prodbe.d_gtin2u,prodbe.0matl_group,prodbe.d_raube,prodbe.d_gtin1c___t,
prodbe.d_gtin1u___t,prodbe.d_gtin2c___t,prodbe.d_gtin2u___t,prodbe.d_raube___t,prodbe.d_uvp,prodbe.0del_flag,prodbe.0sapmaterial_code_trim,prodbe.product_brand,
prodbe.product_brand_cluster,prodbe.product_category,prodbe.product_cnk_material_code,prodbe.product_cnk_material_name,prodbe.product_country_code,prodbe.product_iri_ean_code,
prodbe.product_iri_material_name,prodbe.main_sap_material_code,prodbe.product_portfolio_management,prodbe.product_name,prodbe.product_status,prodbe.product_sub_brand,
...
saleorg.0salesorg___t
 ...
 from emea_quality_enr_bnlx.prep_fact_sap_sd_orders_be_remove_prod fact
left join emea_quality_enr_bnlx.dim_prepare_ch_product_dimension_be prodbe on fact.0material=prodbe.0material
...
left join emea_quality_enr_bnlx.dim_prepare_sd_cust_soldto_dimension_be custsold on fact.0sold_to=custsold.0customer_soldto
