CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_bnlx.ch_customer_mapping_be_live_edit (
  ETLChecksum STRING,
  ...
  extract_date DATE)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/bnlx/ch_customer_mapping_be_live_edit'
TBLPROPERTIES (
