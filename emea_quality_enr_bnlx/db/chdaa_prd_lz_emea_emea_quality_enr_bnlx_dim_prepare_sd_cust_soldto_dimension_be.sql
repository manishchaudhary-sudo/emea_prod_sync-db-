CREATE TABLE chdaa_prd_lz_emea.emea_quality_enr_bnlx.dim_prepare_sd_cust_soldto_dimension_be (
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/enrichment/bnlx/dim_prepare_sd_cust_soldto_dimension_be'
TBLPROPERTIES (
