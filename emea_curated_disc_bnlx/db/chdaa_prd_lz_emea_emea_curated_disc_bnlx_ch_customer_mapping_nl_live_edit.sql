CREATE TABLE chdaa_prd_lz_emea.emea_curated_disc_bnlx.ch_customer_mapping_nl_live_edit (
  ETLChecksum STRING,
  ...
  extract_date DATE)
USING delta
LOCATION 'abfss://curated@zpdatacoresadpemea.dfs.core.windows.net/discovery/bnlx/ch_customer_mapping_nl_live_edit'
TBLPROPERTIES (
