CREATE TABLE chdaa_prd_lz_emea.emea_curated_disc_bnlx.dwh_fact_ch_sd_orders_be_sql (
  ...
  ETLChecksum STRING)
USING delta
LOCATION 'abfss://curated@zpdatacoresadpemea.dfs.core.windows.net/discovery/bnlx/dwh_fact_ch_sd_orders_be_sql'
TBLPROPERTIES (
