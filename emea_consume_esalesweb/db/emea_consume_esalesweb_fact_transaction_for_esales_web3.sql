CREATE VIEW emea_consume_esalesweb.fact_transaction_for_esales_web3 (
  year,
  bloz,
...
FROM
    chdaa_prd_lz_emea.emea_consume_ceec_pl.fact_transaction_for_esales_web fact
LEFT JOIN
...
GROUP BY
    fact.year, fact.bloz, fact.id_external_reporting, cust.id_esalesweb