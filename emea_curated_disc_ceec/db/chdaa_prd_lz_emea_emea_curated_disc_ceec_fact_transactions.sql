CREATE TABLE chdaa_prd_lz_emea.emea_curated_disc_ceec.fact_transactions (
  document_id STRING,
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://curated@zpdatacoresadpemea.dfs.core.windows.net/discovery/ceec/fact_transactions'
CLUSTER BY (transaction_source,transaction_time_id)
TBLPROPERTIES (
