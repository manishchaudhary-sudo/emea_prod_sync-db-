CREATE VIEW emea_quality_int_bnlx.vw_prep_fact_sap_sd_orders_nl_remove_prod (
  `0doc_number`,
  `0s_ord_item`,
  `0dsdel_date`,
  `0soursystem`,
...
(
    ...
    where comc.COMPANY_CODE_ID='0188' AND mat.prodh_hl_id_01='16' and coalesce(LOG_SOURCE_SYSTEM_ID,'')!=''
  ...
  Left join 
  (
  Select sap_material_code,portfolio_management,country_code from emea_quality_corr_bnlx.vw_man_ch_product_mapping where country_code='NL'
