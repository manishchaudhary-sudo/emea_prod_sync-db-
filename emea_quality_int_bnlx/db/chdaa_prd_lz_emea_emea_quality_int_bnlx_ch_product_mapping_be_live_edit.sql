CREATE TABLE chdaa_prd_lz_emea.emea_quality_int_bnlx.ch_product_mapping_be_live_edit (
  ETLChecksum STRING,
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/integration/bnlx/ch_product_mapping_be_live_edit'
TBLPROPERTIES (
