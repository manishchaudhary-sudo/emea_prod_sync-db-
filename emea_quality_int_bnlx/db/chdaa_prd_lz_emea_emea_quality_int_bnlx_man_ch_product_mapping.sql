CREATE TABLE chdaa_prd_lz_emea.emea_quality_int_bnlx.man_ch_product_mapping (
  ...
  ETLLineageID STRING)
USING delta
LOCATION 'abfss://quality@zpdatacoresadpemea.dfs.core.windows.net/integration/bnlx/man_ch_product_mapping'
TBLPROPERTIES (
