CREATE VIEW emea_quality_int_bnlx.vw_dim_prepare_ch_product_dimension_be (
  `0material`,
  `0material___t`,
  `0matl_type`,
  `0matl_type___t`,
        ...
        (
          ...
          (
            ...
            Select distinct country_code,main_sap_material_code,portfolio_management,sap_material_code
                  from emea_quality_int_bnlx.man_ch_product_mapping WHERE country_code='BE' AND portfolio_management != 'Delisted'
    ...
    (
        ...
        (
          (
            ...
            Select distinct main_sap_material_code from emea_quality_int_bnlx.man_ch_product_mapping  where country_code='BE'
          ) Prodm
          inner join
          (
