CREATE VIEW emea_quality_int_bnlx.vw_dim_prepare_sd_cust_soldto_dimension_be (
  status,
  sap_apb_code,
  organization,
    ...
    from
      ...
      (
              (
                ...
                Select distinct main_sap_customer_code from emea_quality_int_bnlx.man_ch_customer_mapping where country_code='BE'
              ) Mainsap
      ...
      inner join
      (
        Select distinct main_sap_customer_code,sap_customer_code from emea_quality_int_bnlx.man_ch_customer_mapping where country_code='BE'
